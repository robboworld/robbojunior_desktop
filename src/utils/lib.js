...
//created by Yaroslav
export function copyImageFromCanvasToImg(canvas){

  var oImg = document.createElement("img");
     oImg.setAttribute('src', canvas.toDataURL('image/svg+xml'));
...
export function newDiv_extended (parent, x, y, w, h, styles,inner_content,attributes) {
    var el = document.createElement('div');
    el.style.position = 'absolute';
    el.style.top = y + 'px';
    el.style.left = x + 'px';
